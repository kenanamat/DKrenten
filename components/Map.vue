...
<template>
  <div class="my-8 flex justify-center">
    <div class="relative m-2 w-full max-w-[1440px] sm:m-10">
      <h2 class="text-primary mb-10 text-4xl font-bold">Werkgebied</h2>
      <div class="grid items-center gap-8 gap-y-12 md:grid-cols-12">
        <div class="rounded-xl bg-slate-200 p-8 md:col-span-5">
          <ul
            class="grid justify-center gap-8 sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-2"
          >
            <li
